  ...
  return (
    <FadeSection className="w-full h-full rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 overflow-y-auto">
      <div className="flex items-start sm:items-center justify-between gap-3">
        <p className="text-xs sm:text-sm uppercase tracking-[0.25em] sm:tracking-[0.3em] text-white/60">Portfolio Bio</p>
        <button
          type="button"
          onClick={onBack}
      ...
      <div className="mt-5 sm:mt-6 grid grid-cols-2 sm:block gap-4">
        ...
        <div className="sm:mt-4">
          <p className="text-xs sm:text-sm text-white/60">Availability</p>
          <p className="text-sm sm:text-base">{profile.availability}</p>
        </div>
      </div>

      <div className="mt-5 sm:mt-6">
        <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-white/60">Highlights</p>
      ...
      <div className="mt-5 sm:mt-6">
        <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-white/60">Core Skills</p>
      ...
      <div className="mt-5 sm:mt-6">
        <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-white/60">Experience</p>
